...
exports.getSpecificArtworkPublic = exports.deleteArtwork = exports.updateArtwork = exports.createArtwork = exports.getUserArtworks = exports.getSpecificArtwork = exports.getAllArtworks = void 0;
...
const getAllArtworks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const allArtworks = yield artworkModel_1.default.find({});
...
const getSpecificArtwork = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const getSpecificMessages = {
        missing: `Artwork not found`,
        failure: `Problem Loading Artwork`
    };
    const artworkID = req.params.id;
    const specificArtwork = yield artworkModel_1.default.findById(artworkID);
    if (!specificArtwork) {
...
exports.getSpecificArtwork = getSpecificArtwork;
...
const getSpecificArtworkPublic = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const getSpecificMessages = {
        missing: `Artwork not found`,
        failure: `Problem Loading Artwork`
    };
...
exports.getSpecificArtworkPublic = getSpecificArtworkPublic;
//INCLUDE A FUNCTUON THAT WILL RETURN ONLY THE ARTWORKS CREATED BY THAT ARTIST
const getUserArtworks = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
const createArtwork = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const newArtwork = yield artworkModel_1.default.create({
            title,
            artist,
            image,
            price,
...
const deleteArtwork = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        yield specificArtwork.deleteOne();
